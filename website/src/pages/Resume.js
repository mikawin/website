                            ...
                            <div className='columns'>
                                ...
                                <div className='column'>
                                    <div className=' button-formatting'>
                                        <a class="button is-light is-medium" href='https://drive.google.com/file/d/1rngZfOP1SU2DFDQJCgjHSrmFSWXq-sy2/view?usp=sharing'>Download PDF</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <Paper elevation={0} sx={{ backgroundColor: '#f3faff' }}>
                            <div className='columns'>
                                ...
                                <div className='column is-two-thirds'>
                                    ...
                                    <div className='job-description'>
                                        Hanled over 50 customer inquiries involving oversseeing amentities such as concessions, handling
